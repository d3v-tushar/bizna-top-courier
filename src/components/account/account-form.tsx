...
import { SignupFormSchema } from '@/lib/auth/validations';
...
function SubmitButton() {
  ...
  return (
    <Button disabled={pending} size="sm" aria-disabled={pending} type="submit">
      {pending ? <LoadingDots /> : 'Update'}
    </Button>
  );
}
